...
namespace StarterAssets
{
    ...
    public class ThirdPersonControllerCustom : MonoBehaviour
    {
        ...
        [Tooltip("Crouch walk speed of the character in m/s")]
        ...
        public float MainSensitivity = 2f;
        ...
        private void Update()
        {
            ...
            JumpAndGravity();
            GroundedCheck();
            if (_input.sprint && !_input.crouch && !_input.aim)
            {
                Sprint();
            }
            else if (!_input.sprint|| _input.crouch|| _input.aim)
            {
                Walk(1);
            }
        ...
        private void CameraRotation()
        {
                ...
                if (_input.look.sqrMagnitude >= _threshold && !LockCameraPosition && (Input.GetKey(KeyCode.Mouse0)|| Input.GetKey(KeyCode.Mouse1)))
                {
        ...
        public void Walk(float temp)
        {
            ...
            // move the player
            _controller.Move(targetDirection.normalized * (_speed * Time.deltaTime)* temp +
                             new Vector3(0.0f, _verticalVelocity, 0.0f) * Time.deltaTime* temp);
        ...
        private void Dance()
        {
            ...
            {
                _animator.SetTrigger("Dance" + randomNumber);
            }
        }
        ...
        private void Aim()
        {
            ...
            SetSensitivity(MainSensitivity);
